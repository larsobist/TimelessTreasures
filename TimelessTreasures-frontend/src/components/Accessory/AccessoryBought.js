...
const AccessoryBought = () => {
    ...
    return (
        <div className="container" style={{ width: '80%' }}>
            <h1>Glückwunsch zum Kauf!</h1>
            <b>Wir haben dem Verkäufer Bescheid gegeben, sodass er den Versand abwickelt!</b>
            <div className="card">
                <img
...
export default AccessoryBought;
